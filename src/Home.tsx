...
const FILM = "/media/compass-film.mp4";
 ...
 return <div className="compass-site">
  ...
  <main id="main">
   ...
   <section id="film" className="film-section">
    ...
    <div className="film-heading"><h2>Your first thought isn't<br/>always the whole story.</h2><p>A founder thinks he needs to walk away.<br/>A conversation helps him find what he actually wants.</p></div>
    <div className="film-player" data-playing={playing}>
     <video ref={film} src={FILM} poster="/assets/film-poster.webp" controls playsInline preload="metadata" onPlay={()=>setPlaying(true)} onPause={()=>setPlaying(false)} onError={()=>setFailed(true)} aria-label="COMPASS: Find your next step, 60-second product concept film">
    ...
    <div className="film-bottom"><p>AI-generated people and scenes. A fictional conversation illustrating an intended experience.</p><a href={FILM} target="_blank" rel="noreferrer">Open film <Arrow/></a></div>
    <details className="film-transcript"><summary>Read the conversation</summary><div><p><b>You:</b> I think I need to leave the company.</p><p><b>COMPASS:</b> What's making you say that?</p><p><b>COMPASS:</b> You said the work still matters.</p><p><b>You:</b> It does. I just can't keep doing everything alone.</p><p><b>You:</b> Actually, I don't want to leave. I want things to change.</p><p><b>COMPASS:</b> That's a different conversation.</p><p><b>COMPASS:</b> What would you want your partner to understand?</p><p><b>You:</b> That I need us to share the weight.</p><p><b>You:</b> I'll ask her to meet. No pitch. Just an honest conversation.</p><p><b>COMPASS:</b> That sounds like a place to start.</p></div></details>
   </section>
